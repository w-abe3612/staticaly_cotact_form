...
var $face = snapsvg__WEBPACK_IMPORTED_MODULE_0___default()('#face');
var $mouse = snapsvg__WEBPACK_IMPORTED_MODULE_0___default()('#mouse');
$face.attr({
  "translate": "transform(0,0)"
});
const svgAnimation = function () {
  snapsvg__WEBPACK_IMPORTED_MODULE_0___default.a.animate(0, -150, function (val) {
    snapsvg__WEBPACK_IMPORTED_MODULE_0___default()('#face').transform(`translate(0,${val})`);
  }, 300, mina.easeout);
};

/***/ }),

/***/ "./src/js/footerFixed.js":
/*!*******************************!*\
  !*** ./src/js/footerFixed.js ***!
  \*******************************/
/*! no static exports found */
...
$(function () {
  ...
  let Validation = {
    checkAllForm: function () {
      ...
      dateValidation.each(function () {
        ...
        let validateTypes = $(this).attr("date-validation").split("|");
  ...
  let ButtonOnBehavior = {
    ...
    confirmBtnOnClick: function (buttonId) {
      ...
      if (validateFlg === true) {
        ...
        Object(_router_js__WEBPACK_IMPORTED_MODULE_0__["router"])("confirm");
      } else {
        Error.appendWarning();
        ...
        Object(_router_js__WEBPACK_IMPORTED_MODULE_0__["router"])("error");
      }
    },
    returnBtnOnClick: function (buttonId) {
      ...
      this.switchSteps(buttonId);
      this.submitBtn().prop("disabled", true);
      Object(_router_js__WEBPACK_IMPORTED_MODULE_0__["router"])("contact");
    },
    submitsBtnOnClick: function (buttonId) {
      this.ddSwitchClass(buttonId);
      this.switchDisabled(buttonId);
      this.switchSteps(buttonId);
      Object(_router_js__WEBPACK_IMPORTED_MODULE_0__["router"])("thanks");
      $containerObject.attr("data-state", "thanks");
      Object(_animation_js__WEBPACK_IMPORTED_MODULE_1__["svgAnimation"])(); //FormEventBehavior.sendMail();
    },
  ...
  let FormEventBehavior = {
    replaceHyphen: function (e) {
      ...
      let replaceTarget = attreVlidation.filter(function (x) {
        return x === "tel" || x === "zipCode";
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _footerFixed_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./footerFixed.js */ "./src/js/footerFixed.js");
/* harmony import */ var _footerFixed_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_footerFixed_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _function_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./function.js */ "./src/js/function.js");
